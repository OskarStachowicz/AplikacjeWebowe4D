...
if (isset($_POST['submit'])) {
    ...
    if (is_numeric($liczba1) && is_numeric($liczba2) && is_numeric($liczba3)) {
        ...
        echo "Najmniejsza liczba spośród $liczba1, $liczba2 i $liczba3 to: $najmniejsza.";
    } else {
...
<head>
    ...
    <title>Znajdź najmniejszą liczbę</title>
</head>
<body>
    <form method="post" action="">
        ...
        <button type="submit" name="submit">Znajdź najmniejszą liczbę</button>
    </form>
</body>
</html>